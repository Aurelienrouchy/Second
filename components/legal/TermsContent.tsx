/**
 * TermsContent — body of the Terms of Service (CGU), presentational only.
 *
 * Factored out of app/settings/terms.tsx so the EXACT SAME legal copy is
 * reused by both:
 *  - the authenticated settings route (app/settings/terms.tsx)
 *  - the PUBLIC route reachable at consent time (app/legal/terms.tsx)
 *
 * Loi 25 (art. 12): the legal documents must be accessible and readable at the
...
function TermsContentComponent() {
  return (
...
export const TermsContent = React.memo(TermsContentComponent);
